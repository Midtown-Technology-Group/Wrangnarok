// Slice B coverage for src/d1-plan.ts (issue #302): EXPLAIN passthrough,
// coarse SCAN/SEARCH classification, and the review-everything verdict
// shape. Pure unit: stub database, no Worker runtime.
