...
Dated: 2026-09-18. Baseline: upstream `gobifrost/bifrost@3543c7ebee0e1bd9a2cab6dfba080a30621b1c5f` vs Wrangnarok `origin/main@9cc00ed` (lane `lane/177-sync-slice`; provider allowances re-checked 2026-09-17, unchanged).
...
| Build/CI costs (Vite UI, workerd test matrix) | free | Local `vite build` plus GitHub-hosted CI minutes; no Cloudflare build product is adopted. Advisory soft reference (730 KiB + 8 KiB reserve) tracks deploy size well under the 3 MB provider hard cap. |
